...
public class SomeService {
    ...
    /**
     * 3.1. Метод возвращает Fizz для чисел кратных 3, Buzz для кратных 5, и FizzBuzz
     * для кратных 3 и 5 одновременно
     */
    public String fizzBuzz(int i) {

        if (i%15==0) return "FizzBuzz";
        if (i%3==0) return "Fizz"; // вместо этого напишите свою реализацию
        if (i%5==0) return "Buzz"; // вместо этого напишите свою реализацию
    ...
    public double calculatingDiscount(
            double purchaseAmount, int discountAmount) {
